...
Supports PDF, Markdown, and TXT file text extraction.
"""
...
class FileParser:
    """File parser supporting PDF, Markdown, and plain text."""
    ...
    @classmethod
    def parse(cls, raw_bytes: bytes, filename: str) -> str:
        """Parse raw bytes from an uploaded file into plain text.
        ...
        # Text-based files (.txt, .md, .markdown)
        try:
